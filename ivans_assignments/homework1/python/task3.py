...
threshold = 0.008 # todo: choose an appropriate value
...
print(np.shape(I_rgb))

# Til Strøm: hvorfor blir ikke bildet gå med mindre vi forteller imshow at cmap = gray?? Skal ikke grayscale
print(np.max(I_gray))
